...
Original file is located at
    https://colab.research.google.com/drive/14aoAWnSfuWKMuay24cHhM_IHQ2r0uLwl
"""
...
plot_model(model, to_file='EffB4.png', show_shapes=True,show_layer_names=True, dpi = 72)
Image(filename='EffB4.png')